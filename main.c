...
/*   Updated: 2025/08/26 20:17:39 by mmedjahe         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    init_mlx(t_cub *cub)
{
    ...
    cub->mlx.win = mlx_new_window(cub->mlx.mlx, cub->width * 32, cub->height * 32, "cub3D");
    if(!cub->mlx.win)
        ft_error("window init failed", cub);
    cub->mlx.img = mlx_new_image(cub->mlx.mlx, cub->width * 32, cub->height * 32);
    if (!cub->mlx.img)
